...
export default function ApplicationStats({ application, candidate }) {
  return (
          ...
          <div className="sm:flex sm:space-x-5">
            <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
              <p className="text-xl font-bold text-gray-900 sm:text-2xl">
                {`${application.exam.entrance.code} - ${application.exam.entrance.name} ${application.exam.description}`}
              </p>
